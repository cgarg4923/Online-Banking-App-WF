            ...
            <Container component="main">
                ...
                <Box sx={{
                    ...
                    <Box component="form" sx={{ mt: 3, width: 500 }} onSubmit={handlerSubmit}>
                        ...
                        <Grid>
                            <Grid item sm={12}>
                                <TextField fullWidth label="User ID" type="text" value={customerId} margin="normal" inputLabelProps={{ shrink: true }} inputProps={{ readOnly: true }}>
                                </TextField>
                            </Grid>
                        </Grid>
                        <Grid>
                        ...
                        <Grid>
                            <Grid item sm={12}>
                                <TextField fullWidth label="Initial Account Balance" type="number" onChange={handleAccountBalance} placeholder="Enter the minimum balance" value={accountBalance} margin="normal">
                                </TextField>
                            </Grid>
                        </Grid>
                        <Grid>
